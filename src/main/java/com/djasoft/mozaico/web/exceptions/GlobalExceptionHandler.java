...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleValidationExceptions(MethodArgumentNotValidException ex) {
        log.warn("Error de validación capturado: {}", ex.getMessage());
    ...
    @ExceptionHandler(CompanyContextViolationException.class)
    public ResponseEntity<ApiResponse<?>> handleCompanyContextViolationException(CompanyContextViolationException ex) {
        log.warn("Violación de contexto de empresa: {}", ex.getMessage());
        ApiResponse<?> errorResponse = ApiResponse.error(
                HttpStatus.FORBIDDEN.value(),
                "Acceso denegado",
                ex.getMessage());
